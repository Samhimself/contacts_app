...
public class ContactsAppController {
    ...
    public void initialize() {
        ...
        contactsListView.setCellFactory(new Callback<ListView<Contact>, ListCell<Contact>>() {
            @Override
    ...
    public void saveButtonPressed(ActionEvent event) {
        ...
        // Get the text found in the Text boxes
        ...
        if (contactSelected == null) {
            contacts.add(new Contact(lastName, firstName, emailAddress, phoneNumber, homeAddress, image));

            // Clear selection for new contact
            addButton.fire();
        } else { // if the contacts is found, change its information
    ...
    public void contactsImageViewClicked(MouseEvent event) {
        // Open FileChooser and give it a title
